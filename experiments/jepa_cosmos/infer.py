...
def main() -> None:
    ...
    if not args.no_wandb:
        ...
        log_video(run, "inference/context", context_path, args.fps)
        log_video(run, "inference/ground_truth_future", ground_truth_path, args.fps)
        log_video(run, "inference/predicted_future", predicted_path, args.fps)
        log_video(run, "inference/comparison", comparison_path, args.fps)
